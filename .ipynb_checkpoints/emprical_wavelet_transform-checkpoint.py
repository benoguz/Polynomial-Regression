...
#   burayı ben ekledim, nan ve inf durumlarını handle etmek için. Bunu kullanmak için original datayı -1,1 aralığına scale etmelisin
#   fMirr = np.nan_to_num(fMirr, nan=np.nanmean(fMirr), posinf = 1, neginf=-1)
